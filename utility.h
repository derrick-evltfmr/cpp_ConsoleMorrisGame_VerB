...
enum ProgramMode { PROGRAM_MODE_NOT_SET = -1, PLAY_MORRIS_GAME, MINIMAXOPENING, MINIMAXGAME, ABOPENING, ABGAME, MINIMAXOPENINGBLACK, MINIMAXGAMEBLACK, MINIMAXOPENINGIMPROVED, MINIMAXGAMEIMPROVED };
...
enum WinningSituation {WINNING_SITUATION_NOT_SET = -1, REMAINING_JUST_2_PIECES, NO_MORE_AVAILABLE_MOVES, REPEATED_WITHOUT_FORMING_A_MILL};
